...
/// AUDIT: overflow control to be added:
		require((users_map[msg.sender].ether_balance + msg.value) >= users_map[msg.sender].ether_balance);		
...
/// AUDIT: this leaves duplicated users at the end of a list. Let's remove last entry
		users_list.pop();	
	}
